...
var towerInfo = {
	...
	"tosb": ["ToSB", 6, "Zone 6", "Tower", 0],
	"topr": ["ToPR", 6, "Zone 6", "Tower", 0],
	...
	// ATw
	"tofz": ["ToFZ", 1, "ATw", "Tower", 0],
	"tovt": ["ToVT", 2, "ATw", "Tower", 0],
	"tocwc": ["ToCWC", 3, "ATw", "Tower", 0],
	"towmt": ["ToWMT", 4, "ATw", "Tower", 0],
	"towia": ["ToWIA", 5, "ATw", "Tower", 0],
	"towow": ["ToWoW", 5, "ATw", "Tower", 0],
	"tosr": ["ToSR", 5, "ATw", "Tower", 0],
	"tolll": ["ToLLL", 5, "ATw", "Tower", 1],
	"tofsf": ["ToFSF", 6, "ATw", "Tower", 0],
	"tocb": ["ToCB", 6, "ATw", "Tower", 0],
	"tomd": ["ToMD", 6, "ATw", "Tower", 1],
	"torh": ["ToRH", 6, "ATw", "Tower", 0],
	...
	"sobc": ["SoBC", 4, "TSA", "Steeple", 0],
	"sotmn": ["SoTMN", 4, "TSA", "Steeple", 0],
	"sotmm": ["SoTMM", 4, "TSA", "Steeple", 2],
	"totutu": ["ToTUTU", 5, "TSA", "Tower", 5],
	"toir": ["ToIR", 5, "TSA", "Tower", 1],
	"soib": ["SoIB", 5, "TSA", "Steeple", 1],
